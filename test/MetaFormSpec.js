...
//                name: 'Andre'
//            };
//            let instance = ReactTestUtils.renderIntoDocument(<MetaForm fields={dataProvider.mergeFields(entityType.fields, layout.fields)} model={model}/>);
//            var fields = instance.getMergedFields();
...
//            };
//            let instance = ReactTestUtils.renderIntoDocument(<MetaForm fields={dataProvider.mergeFields(entityType.fields, layout.fields)} model={model}/>);
//            var modelToTest = instance.state.model;
